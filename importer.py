...
section_df = pandas.read_csv("data/main_cbed_dbo_Levels.csv").replace(
...
question_df = pandas.read_csv("data/main_cbed_dbo_Questions.csv").replace(
    numpy.nan, "", regex=True
)
...
for index, row in question_df.iterrows():
    ...
    question = Question.objects.create(
        id=id_, section_id=section_id, content=content, order=id_
    )
    print(question)

answer_df = pandas.read_csv("data/main_cbed_dbo_Answers.csv").replace(
    numpy.nan, "", regex=True
)
